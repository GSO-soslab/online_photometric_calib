...
class TrackVisualizer
{
  ...
  private:
    ...
    std::unordered_map<int, cv::Point2f> predicted_pts_;
};
...
public:
    ...
    cv::Mat get_visualized_img();

private:
    /**
     * tracking feature visualization
     */
    size_t feature_id_;
    IdVector prev_ids_;

    IdVector visualized_feature_ids_;
    Point2fVector visualized_features_;
